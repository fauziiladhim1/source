...
const LayerControl = ({ layers, onToggle }) => {
    ...
    // Removed facilityIcons as the "Sarana dan Prasarana" group is gone.
    // If you add other point layers that use icons, you'll need to reintroduce this and the corresponding iconPaths in Map.jsx.
                    ...
                    <div key={group.id} className="bg-gray-700 p-3 rounded-md shadow-sm">
                        ...
                        {group.visible && (
                            <div className="ml-2 mt-3 text-sm text-gray-300">
                                ...
                                {group.id === 'bangunan-group' && (
                                    <>
                                        <div className="flex items-center space-x-3 mb-1">
                                            ...
                                            <span>Bangunan (Area)</span>
                                        </div>
                                        <div className="flex items-center space-x-3 mb-1">
                                            <div className="w-5 h-5 rounded-full" style={{ backgroundColor: '#00BFFF', border: '1px solid rgba(255,255,255,0.2)', boxShadow: '0 1px 3px rgba(0,0,0,0.3)' }}></div>
                                            <span>Bangunan (Titik)</span>
                                        </div>
                                    </>
                                )}
                                ...
                                {group.id === 'umkm-group' && (
                                    <div key="umkm-legend" className="flex items-center space-x-3 mb-1">
                                        <div className="w-5 h-5 rounded-full" style={{ backgroundColor: '#FFD700', border: '1px solid rgba(255,255,255,0.2)', boxShadow: '0 1px 3px rgba(0,0,0,0.3)' }}></div>
                                        <span>UMKM</span>
                                    </div>
                                )}
